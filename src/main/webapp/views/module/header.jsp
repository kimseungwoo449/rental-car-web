...
<body>
	<header>
		...
		<div id="navs">
			<nav id="reservation-check" onclick="location.href='/mypage'">예약확인</nav>
			<nav id="board" onclick="location.href='/allBoardAction/pageCount?pageCount=1'">문의게시판</nav>
			<nav id="notice" onclick="location.href='/allNoticeAction/pageCount?pageCount=1'">공지사항</nav>
