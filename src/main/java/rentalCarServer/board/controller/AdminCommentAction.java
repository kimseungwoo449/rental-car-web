...
/**
 * Servlet implementation class AdminCommentAction
 */
@WebServlet("/AdminCommentAction")
public class AdminCommentAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminCommentAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String adminComment = request.getParameter("admin-comment");
		...
		if(!(adminComment==null||adminComment.equals(""))) {
			...
			boardDto.setAdminComment(adminComment);
			boardDto.setCommented(true);
			
			boardDao.updateAddminComment(boardDto);
		}
